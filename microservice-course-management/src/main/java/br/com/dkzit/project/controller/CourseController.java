...
import br.com.dkzit.project.intercomm.UserClient;
import br.com.dkzit.project.service.CourseService;
...
public class CourseController {
    ...
    public ResponseEntity<?> findStudentsOfCourse(@PathVariable Long courseId){
        ...
        List<String> studends = userClient.getUserNames(userIdList);

        return ResponseEntity.ok(studends);
    }
}
